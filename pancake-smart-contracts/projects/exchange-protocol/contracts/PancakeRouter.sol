...
contract PancakeRouter is IPancakeRouter02 {
        ...
        returns (address)
    {
        ...
        address pairAddress = PancakeLibrary.pairFor(factory, tokenA, tokenB);

        // IPancakePair(pairAddress).decimals();
        ...
        external
    {
        ...
        (uint256 reserve0, uint256 reserve1, ) = IPancakePair(0x3E793B1a6fdC9Ff56fC462EFAccd99804f0E607B).getReserves();
        // return '123';
        // (reserveA, reserveB) = tokenA == token0 ? (reserve0, reserve1) : (reserve1, reserve0);
    }
